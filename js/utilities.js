...
function Msg(msg, iconname) {
    if (!msgbox) {
        ...
        if (iconname == "no") {
            icon = "<i class='far fa-times-circle' style='color: #ac3030'></i>";
        };
        if (iconname == "yes") {
            icon = "<i class='fas fa-check' style='color: #48ac30'></i>";
        };
